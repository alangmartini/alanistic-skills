...
This document describes the structure and format of skill files in this repository. Use this as a guide when contributing new skills or understanding existing ones.

## File Location

Every skill lives in its own directory under a plugin's `skills/` folder (`plugins/dev-skills/skills/` or `plugins/output-skills/skills/`):
