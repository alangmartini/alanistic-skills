...
User will invoke with "$dev-skills:implement feature to be implemented/fixed"
...
Then, Spawn an subagent to invoke the $dev-skills:spec-driven-development skill with these answers./
...
2.  Spawn an subagent to invoke the $dev-skills:planning-and-task-breakdown
The subagent should:
...
Spawn an subagent to invoke the $dev-skills:incremental-implementation skill alongside $dev-skills:test-driven-development skill.
...
5. Spawn an subagent to invoke the $dev-skills:code-review-and-quality skill.
...
6. Spawn an subagent to invoke the $dev-skills:code-simplification skill.
...
7. Now, we will ship. Invoke the $dev-skills:shipping-and-launch skill.
...
8. Create a between-version changelog fragment. Invoke the $dev-skills:create-changelog-fragment skill after the ship decision so the completed work has a release-note-ready artifact for the next version.
