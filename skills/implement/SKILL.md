...
User will invoke with "$agent-skills-codes:implement feature to be implemented/fixed"
...
Then, Spawn an subagent to invoke the $agent-skills-codes:spec-driven-development skill with these answers./
...
2.  Spawn an subagent to invoke the $agent-skills-codes:planning-and-task-breakdown
The subagent should:
...
Spawn an subagent to invoke the $agent-skills-codes:incremental-implementation skill alongside $agent-skills-codes:test-driven-development skill.
...
5. Spawn an subagent to invoke the $agent-skills-codes:code-review-and-quality skill.
...
6. Spawn an subagent to invoke the $agent-skills-codes:agent-skills:$agent-skills-codes:code-simplification skill.
...
7. Now, we will ship. Invoke the $agent-skills-codes:shipping-and-launch skill.
